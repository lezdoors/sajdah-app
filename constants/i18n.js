...
export const translations = {
  en: {
    ...
    qiyam_reminder: 'Qiyam al-Layl',
    qiyam_reminder_desc: 'Last third of the night',
    friday_kahf_reminder: 'Surah Al-Kahf',
    friday_kahf_reminder_desc: 'Every Friday morning',
    ...
    // Calculation Methods (short — displayed inline)
    calc_method_mwl: 'MWL',
    calc_method_isna: 'ISNA',
    calc_method_egyptian: 'Egyptian',
    ...
    calc_method_tehran: 'Tehran',
    // Calculation Methods (long — displayed in picker)
    calc_method_long_mwl: 'Muslim World League (MWL)',
    calc_method_long_isna: 'Islamic Society of North America (ISNA)',
    calc_method_long_egyptian: 'Egyptian General Authority',
    calc_method_long_karachi: 'Univ. of Islamic Sciences, Karachi',
    calc_method_long_dubai: 'Dubai',
    calc_method_long_qatar: 'Qatar',
    calc_method_long_kuwait: 'Kuwait',
    calc_method_long_singapore: 'Singapore',
    calc_method_long_turkey: 'Diyanet, Turkey',
    calc_method_long_tehran: 'Inst. of Geophysics, Tehran',
  ...
  ar: {
    ...
    reminders_section: 'تذكيرات',
    qiyam_reminder: 'قيام الليل',
    qiyam_reminder_desc: 'الثلث الأخير من الليل',
    friday_kahf_reminder: 'سورة الكهف',
    friday_kahf_reminder_desc: 'كل يوم جمعة صباحاً',
    ...
    // Calculation Methods (short)
    calc_method_mwl: 'MWL',
    calc_method_isna: 'ISNA',
    calc_method_egyptian: 'مصر',
    ...
    calc_method_tehran: 'طهران',
    // Calculation Methods (long)
    calc_method_long_mwl: 'رابطة العالم الإسلامي (MWL)',
    calc_method_long_isna: 'الجمعية الإسلامية لأمريكا الشمالية (ISNA)',
    calc_method_long_egyptian: 'الهيئة المصرية العامة للمساحة',
    calc_method_long_karachi: 'جامعة العلوم الإسلامية، كراتشي',
    calc_method_long_dubai: 'دبي',
    calc_method_long_qatar: 'قطر',
    calc_method_long_kuwait: 'الكويت',
    calc_method_long_singapore: 'سنغافورة',
    calc_method_long_turkey: 'ديانت، تركيا',
    calc_method_long_tehran: 'معهد الجيوفيزياء، طهران',
  ...
  fr: {
    ...
    reminders_section: 'RAPPELS',
    qiyam_reminder: 'Qiyam al-Layl',
    qiyam_reminder_desc: 'Dernier tiers de la nuit',
    friday_kahf_reminder: 'Sourate Al-Kahf',
    friday_kahf_reminder_desc: 'Chaque vendredi matin',
    ...
    calc_method_tehran: 'Téhéran',
    // Calculation Methods (long)
    calc_method_long_mwl: 'Ligue islamique mondiale (MWL)',
    calc_method_long_isna: 'Société islamique d\'Amérique du Nord (ISNA)',
    calc_method_long_egyptian: 'Autorité générale égyptienne',
    calc_method_long_karachi: 'Univ. des sciences islamiques, Karachi',
    calc_method_long_dubai: 'Dubaï',
    calc_method_long_qatar: 'Qatar',
    calc_method_long_kuwait: 'Koweït',
    calc_method_long_singapore: 'Singapour',
    calc_method_long_turkey: 'Diyanet, Turquie',
    calc_method_long_tehran: 'Inst. de géophysique, Téhéran',
